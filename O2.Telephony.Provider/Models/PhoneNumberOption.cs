namespace O2.Telephony.Provider.Models
{
    ...
    /// 
    /// </summary>
    public class PhoneNumberOption
    {
        /// <summary>
        ...
        public override string ToString()
        {
            return
                string.Format(
                    "[{0}] PhoneNumber: {1}, FriendlyName: {2}, VoiceUrl: {3}, VoiceMethod: {4}, SmsUrl: {5}, SmsMethod: {6}, StatusCallback: {7}, StatusCallbackMethod: {8}",
                    GetType().FullName, PhoneNumber, FriendlyName, VoiceUrl, VoiceMethod, SmsUrl, SmsMethod, StatusCallback, StatusCallbackMethod);
        }
